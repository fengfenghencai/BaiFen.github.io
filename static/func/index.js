...
$(document).ready(function(){
	...
	//唱片
	var epSwiper = new Swiper(".goods .swiper-container", {
		slidesPerView: 3,
		spaceBetween: 30,
...
function goNavSeled(i,n){
	...
	var wt2 = $(".information h2").offset().top - heightPatch;
	var wt3 = $(".goods h2").offset().top - heightPatch;
	var wt4 = $(".service h2").offset().top - heightPatch;
